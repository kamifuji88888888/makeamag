...
export const PLANS: Record<PlanId, PlanDefinition> = {
  ...
  starter: {
    id: 'starter',
    name: 'Starter',
    tagline: 'Lead capture & password protection — without the Issuu price tag.',
    monthlyPrice: 17,
    annualPrice: 14,
    cta: 'Get Starter',
    limits: {
    ...
    featureBullets: [
      ...
      'Lead capture, folders & 30-day analytics',
    ],
  },
  pro: {
    id: 'pro',
    name: 'Pro',
    tagline: 'White-label + custom domain — a fraction of Flipsnack Business.',
    monthlyPrice: 39,
    annualPrice: 29,
    highlighted: true,
    cta: 'Get Pro',
  ...
  publisher: {
    id: 'publisher',
    name: 'Publisher',
    tagline: 'Agencies & teams publishing at scale.',
    monthlyPrice: 79,
    annualPrice: 59,
    cta: 'Get Publisher',
    limits: {
